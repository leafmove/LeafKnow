...
from core.agno.exceptions import ModelProviderError
from core.agno.media import Audio
...
from core.agno.models.response import ModelResponse
from core.agno.run.agent import RunOutput
from core.agno.utils.log import log_debug, log_error, log_warning
from core.agno.utils.openai import _format_file_for_message, audio_to_message, images_to_message
from core.agno.utils.reasoning import extract_thinking_content
    ...
    def get_request_params(
        ...
        if response_format is not None:
            if isinstance(response_format, type) and issubclass(response_format, BaseModel):
                ...
                from core.agno.utils.models.schema_utils import get_response_schema_for_provider
