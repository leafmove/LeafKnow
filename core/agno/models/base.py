...
from core.agno.exceptions import AgentRunException
from core.agno.media import Audio, File, Image, Video
from core.agno.models.message import Citations, Message
from core.agno.models.metrics import Metrics
from core.agno.models.response import ModelResponse, ModelResponseEvent, ToolExecution
from core.agno.run.agent import CustomEvent, RunContentEvent, RunOutput, RunOutputEvent
from core.agno.run.team import RunContentEvent as TeamRunContentEvent
from core.agno.run.team import TeamRunOutputEvent
from core.agno.tools.function import Function, FunctionCall, FunctionExecutionResult, UserInputField
from core.agno.utils.log import log_debug, log_error, log_warning
from core.agno.utils.timer import Timer
from core.agno.utils.tools import get_function_call_for_tool_call, get_function_call_for_tool_execution
...
class Model(ABC):
    ...
    def run_function_call(
        ...
        if isinstance(function_execution_result.result, (GeneratorType, collections.abc.Iterator)):
            ...
            from core.agno.tools.function import ToolResult
