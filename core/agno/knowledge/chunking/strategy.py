...
class ChunkingStrategyFactory:
    ...
    def _create_agentic_chunking(cls, **kwargs) -> ChunkingStrategy:
        from core.agno.knowledge.chunking.agentic import AgenticChunking
    ...
    def _create_document_chunking(cls, **kwargs) -> ChunkingStrategy:
        from core.agno.knowledge.chunking.document import DocumentChunking

        return DocumentChunking(**kwargs)

    @classmethod
    def _create_recursive_chunking(cls, **kwargs) -> ChunkingStrategy:
        from core.agno.knowledge.chunking.recursive import RecursiveChunking

        return RecursiveChunking(**kwargs)

    @classmethod
    def _create_semantic_chunking(cls, **kwargs) -> ChunkingStrategy:
        from core.agno.knowledge.chunking.semantic import SemanticChunking
    ...
    def _create_row_chunking(cls, **kwargs) -> ChunkingStrategy:
        from core.agno.knowledge.chunking.row import RowChunking
    ...
    def _create_markdown_chunking(cls, **kwargs) -> ChunkingStrategy:
        from core.agno.knowledge.chunking.markdown import MarkdownChunking
