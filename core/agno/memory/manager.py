...
from core.agno.utils.log import (
    log_debug,
    log_error,
    log_warning,
...
from core.agno.utils.prompts import get_json_output_prompt
from core.agno.utils.string import parse_response_model_str
...
class MemoryManager:
    ...
    def _get_db_tools(
        ...
        def add_memory(memory: str, topics: Optional[List[str]] = None) -> str:
            ...
            from core.agno.db.base import UserMemory
