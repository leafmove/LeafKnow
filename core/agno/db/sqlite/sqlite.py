...
from core.agno.db.sqlite.schemas import get_table_schema_definition
from core.agno.db.sqlite.utils import (
    apply_sorting,
    bulk_upsert_metrics,
...
from core.agno.db.utils import deserialize_session_json_fields, serialize_session_json_fields
from core.agno.session import AgentSession, Session, TeamSession, WorkflowSession
...
class SqliteDb(BaseDb):
    ...
    def migrate_table_from_v1_to_v2(self, v1_db_schema: str, v1_table_name: str, v1_table_type: str):
        ...
        from core.agno.db.migrations.v1_to_v2 import (
