...
from core.agno.culture.manager import CultureManager
...
from core.agno.session import AgentSession, SessionSummaryManager, TeamSession, WorkflowSession
...
from core.agno.utils.print_response.agent import (
    aprint_response,
    aprint_response_stream,
    print_response,
    print_response_stream,
)
from core.agno.utils.prompts import get_json_output_prompt, get_response_model_format_prompt
...
class Agent:
    ...
    def _reason(
        ...
        if use_default_reasoning:
            ...
            from core.agno.reasoning.helpers import (
                get_next_action,
    ...
    def _log_agent_telemetry(self, session_id: str, run_id: Optional[str] = None) -> None:
        ...
        from core.agno.api.agent import AgentRunCreate, create_agent_run
    ...
    async def _alog_agent_telemetry(self, session_id: str, run_id: Optional[str] = None) -> None:
        ...
        from core.agno.api.agent import AgentRunCreate, acreate_agent_run
