...
from core.agno.eval.utils import async_log_eval, log_eval_run, store_result_in_file
from core.agno.exceptions import EvalError
from core.agno.models.base import Model
from core.agno.team.team import Team
from core.agno.utils.log import log_error, logger, set_log_level_to_debug, set_log_level_to_info
...
""",
    ...
    def run(
        ...
        *,
        ...
        if self.telemetry:
            from core.agno.api.evals import EvalRunCreate, create_eval_run_telemetry
    ...
    async def arun(
        ...
        *,
        ...
        if self.telemetry:
            from core.agno.api.evals import EvalRunCreate, async_create_eval_run_telemetry
