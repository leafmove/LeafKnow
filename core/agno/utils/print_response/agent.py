...
from core.agno.run.agent import RunEvent, RunOutput, RunOutputEvent, RunPausedEvent
from core.agno.utils.log import log_warning
from core.agno.utils.message import get_text_from_message
from core.agno.utils.response import create_panel, create_paused_run_output_panel, escape_markdown_tags, format_tool_calls
...
def print_response_stream(
    ...
    tags_to_include_in_markdown: Set = {"think", "thinking"},
...
def build_panels(
    ...
    show_reasoning: bool = True,
    show_full_reasoning: bool = False,
    tags_to_include_in_markdown: Optional[Set] = None,
    markdown: bool = False,
):
    panels = []
