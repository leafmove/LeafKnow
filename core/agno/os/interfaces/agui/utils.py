...
from core.agno.run.agent import RunContentEvent, RunEvent, RunOutputEvent, RunPausedEvent
from core.agno.run.team import RunContentEvent as TeamRunContentEvent
from core.agno.run.team import TeamRunEvent, TeamRunOutputEvent
...
def stream_agno_response_as_agui_events(
    ...
    if not stream_completed:
        ...
        from core.agno.run.agent import RunCompletedEvent
