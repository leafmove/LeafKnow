...
from core.agno.agent.agent import Agent
from core.agno.db.base import AsyncBaseDb, BaseDb
from core.agno.knowledge.knowledge import Knowledge
from core.agno.os.config import (
    AgentOSConfig,
    DatabaseConfig,
    EvalsConfig,
    EvalsDomainConfig,
...
from core.agno.os.router import get_base_router, get_websocket_router
from core.agno.os.routers.evals import get_eval_router
from core.agno.os.routers.health import get_health_router
from core.agno.os.routers.home import get_home_router
from core.agno.os.routers.knowledge import get_knowledge_router
from core.agno.os.routers.memory import get_memory_router
from core.agno.os.routers.metrics import get_metrics_router
from core.agno.os.routers.session import get_session_router
from core.agno.os.settings import AgnoAPISettings
from core.agno.os.utils import (
...
from core.agno.utils.log import logger
from core.agno.utils.string import generate_id, generate_id_from_name
...
class AgentOS:
    def __init__(
        ...
        if self.telemetry:
            from core.agno.api.os import OSLaunch, log_os_telemetry
    ...
    def get_app(self) -> FastAPI:
        if self.base_app:
            ...
            if self.enable_mcp_server:
                from core.agno.os.mcp import get_mcp_server
        ...
        if self.a2a_interface and not has_a2a_interface:
            from core.agno.os.interfaces.a2a import A2A
