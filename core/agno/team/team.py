...
from core.agno.db.base import AsyncBaseDb, BaseDb, SessionType, UserMemory
from core.agno.exceptions import (
    InputCheckError,
    ModelProviderError,
    OutputCheckError,
    RunCancelledException,
)
from core.agno.guardrails import BaseGuardrail
from core.agno.knowledge.knowledge import Knowledge
from core.agno.knowledge.types import KnowledgeFilter
from core.agno.media import Audio, File, Image, Video
from core.agno.memory import MemoryManager
from core.agno.models.base import Model
from core.agno.models.message import Message, MessageReferences
from core.agno.models.metrics import Metrics
from core.agno.models.response import ModelResponse, ModelResponseEvent
from core.agno.reasoning.step import NextAction, ReasoningStep, ReasoningSteps
from core.agno.run.agent import RunEvent, RunOutput, RunOutputEvent
from core.agno.run.base import RunStatus
from core.agno.run.cancel import (
...
from core.agno.session import SessionSummaryManager, TeamSession, WorkflowSession
from core.agno.tools import Toolkit
from core.agno.tools.function import Function
from core.agno.utils.agent import (
...
from core.agno.utils.common import is_typed_dict, validate_typed_dict
...
from core.agno.utils.hooks import filter_hook_args, normalize_hooks
from core.agno.utils.knowledge import get_agentic_or_user_search_filters
...
from core.agno.utils.message import filter_tool_calls, get_text_from_message
from core.agno.utils.print_response.team import (
    aprint_response,
    aprint_response_stream,
    print_response,
    print_response_stream,
)
from core.agno.utils.reasoning import (
...
from core.agno.utils.response import (
    async_generator_wrapper,
    check_if_run_cancelled,
    generator_wrapper,
)
from core.agno.utils.safe_formatter import SafeFormatter
from core.agno.utils.string import generate_id_from_name, parse_response_model_str
from core.agno.utils.team import format_member_agent_task, get_member_id
...
class Team:
        ...
        try:
            ...
            if self.output_model is None:
                ...
                for event in self._handle_model_response_stream(
                    ...
                    raise_if_cancelled(run_response.run_id)  # type: ignore
                    from core.agno.run.team import IntermediateRunContentEvent, RunContentEvent
    ...
    def _reason(
        ...
        if reasoning_model_provided:
            from core.agno.reasoning.anthropic import is_anthropic_reasoning_model
            from core.agno.reasoning.azure_ai_foundry import is_ai_foundry_reasoning_model
            from core.agno.reasoning.deepseek import is_deepseek_reasoning_model
            from core.agno.reasoning.gemini import is_gemini_reasoning_model
            from core.agno.reasoning.groq import is_groq_reasoning_model
            from core.agno.reasoning.helpers import get_reasoning_agent
            from core.agno.reasoning.ollama import is_ollama_reasoning_model
            from core.agno.reasoning.openai import is_openai_reasoning_model
            from core.agno.reasoning.vertexai import is_vertexai_reasoning_model
            ...
            if (
                ...
                if is_deepseek:
                    from core.agno.reasoning.deepseek import get_deepseek_reasoning
                    ...
                    from core.agno.reasoning.groq import get_groq_reasoning
                    ...
                    from core.agno.reasoning.openai import get_openai_reasoning
                    ...
                    from core.agno.reasoning.ollama import get_ollama_reasoning
                    ...
                    from core.agno.reasoning.azure_ai_foundry import get_ai_foundry_reasoning
                    ...
                    from core.agno.reasoning.gemini import get_gemini_reasoning
                    ...
                    from core.agno.reasoning.anthropic import get_anthropic_reasoning
                    ...
                    from core.agno.reasoning.vertexai import get_vertexai_reasoning
        ...
        if use_default_reasoning:
            from core.agno.reasoning.default import get_default_reasoning_agent
            from core.agno.reasoning.helpers import get_next_action, update_messages_with_reasoning
    ...
    async def _areason(
        ...
        if reasoning_model_provided:
            ...
            if (
                ...
                reasoning_message: Optional[Message] = None
                if is_deepseek:
                    from core.agno.reasoning.deepseek import aget_deepseek_reasoning
                    ...
                    from core.agno.reasoning.groq import aget_groq_reasoning
                    ...
                    from core.agno.reasoning.openai import aget_openai_reasoning
                    ...
                    from core.agno.reasoning.gemini import aget_gemini_reasoning
                    ...
                    from core.agno.reasoning.anthropic import aget_anthropic_reasoning
                    ...
                    from core.agno.reasoning.vertexai import aget_vertexai_reasoning
    ...
    def get_system_message(
        ...
        if self.add_location_to_context:
            from core.agno.utils.location import get_location
    ...
    def _log_team_telemetry(self, session_id: str, run_id: Optional[str] = None) -> None:
        ...
        from core.agno.api.team import TeamRunCreate, create_team_run
    ...
    async def _alog_team_telemetry(self, session_id: str, run_id: Optional[str] = None) -> None:
        ...
        from core.agno.api.team import TeamRunCreate, acreate_team_run
