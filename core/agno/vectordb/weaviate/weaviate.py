...
from core.agno.knowledge.embedder import Embedder
from core.agno.knowledge.reranker.base import Reranker
from core.agno.utils.log import log_debug, log_info, logger
from core.agno.vectordb.base import VectorDb
from core.agno.vectordb.search import SearchType
from core.agno.vectordb.weaviate.index import Distance, VectorIndex
...
class Weaviate(VectorDb):
    ...
    def __init__(
        ...
        # Embedder setup
        if embedder is None:
            from core.agno.knowledge.embedder.openai import OpenAIEmbedder
